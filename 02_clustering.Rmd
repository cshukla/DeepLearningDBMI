...
ggplot(res,aes(x=model,y=adj_rand_index,fill=latent_dims))+geom_boxplot()+theme_bw()+coord_flip()

ggplot(res,aes(x=factor(latent_dimension),y=adj_rand_index,fill=model))+geom_boxplot()+theme_bw()
